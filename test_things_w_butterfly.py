...
ranks = [4 for _ in range(L-lc+1 )] # Increasing this  makes things very slow for current implementation, R^2 x R^2 solves are not parallel

print('ranks for butterfly completion are')
...
print('matrix completion rank',r)
